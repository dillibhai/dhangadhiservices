...
import 'package:myservices/components/desastercontact.dart';
...
class _DesasterDescState extends State<DesasterDesc> {
  final List<String> imageList = [
    "assets/slidingimage/natural.JPG",
    "assets/slidingimage/desaster.jpg",
    "assets/slidingimage/desasterone.jpg",
    "assets/slidingimage/desastertwo.jpg",
  ];
  @override
